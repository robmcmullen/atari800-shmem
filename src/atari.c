...
{
#if 0
	if (Atari800_machine_type != Atari800_MACHINE_5200 && emuos_mode == 3) {
		memset(MEMORY_os, 0, 0x1800);
		memcpy(MEMORY_os + 0x1800, emuos_altirra, 0x2800);
		Atari800_machine_type = Atari800_MACHINE_XLXE;
		Atari800_os_version = SYSROM_BB01R2; /* emulates 800XL rom */
	}
	else
#endif
